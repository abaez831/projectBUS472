...
def getWeather(canvas):
  ...
  api = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=ac84b28a0b85cb20bdacd7d575cef06d"
  ...
  sea_level = int(((json_data['main']['sea_level'] - 273.15) * 1.8 + 32))  # Minimum temperature of the day
  grnd_level = int(((json_data['main']['grnd_level'] - 273.15) * 1.8 + 32))  # Maximum temperature of the day
...
canvas = tk.Tk()
instruction_label = tk.Label(canvas, text="Put the City Name Below", font=("poppins", 20))
